  ...
  <div class="min-h-screen p-6" style="background: var(--color-utd-orange)">
    <div class="mx-auto w-full max-w-2xl">
      ...
      <div v-if="!unlocked" class="bg-white rounded-2xl shadow-xl p-8 max-w-md mx-auto">
        <h1 class="text-2xl font-bold text-black mb-1">Admin Access</h1>
        <p class="text-sm text-black mb-6">Enter the admin password to continue.</p>

        <div class="flex flex-col gap-4">
          <div>
            <label class="block text-sm font-medium text-black mb-1" for="password">
              Password
            </label>
            <input
              id="password"
              ...
              placeholder="••••••••"
              @keyup.enter="unlock"
              class="w-full rounded-lg border border-gray-300 px-4 py-2.5 text-sm text-black placeholder-gray-400 focus:border-orange-400 focus:outline-none focus:ring-2 focus:ring-orange-200 transition"
            />
      ...
      <div v-else class="flex flex-col gap-6">
        ...
        <div class="bg-white rounded-2xl shadow-xl p-6">
          <h2 class="text-base font-bold text-black mb-4">Add Approved Email</h2>
          <div class="flex gap-3">
            <input
              ...
              class="flex-1 rounded-lg border border-gray-300 px-4 py-2.5 text-sm text-black placeholder-gray-400 focus:border-orange-400 focus:outline-none focus:ring-2 focus:ring-orange-200 transition"
            />
            <button
              @click="addEmail"
              :disabled="addLoading"
        ...
        <div class="bg-white rounded-2xl shadow-xl p-6">
          <div class="flex items-center justify-between mb-4">
            <h2 class="text-base font-bold text-black">Approved Emails</h2>
