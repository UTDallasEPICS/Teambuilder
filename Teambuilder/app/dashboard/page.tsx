...
export default function Dashboard() {
  ...
  const [uploaded, isUploaded] = useState(Boolean);
        ...
        <div style={{marginTop: '50px'}} className='flex flex-inline'>
          ...
          <div style={{marginLeft: '100px' }} className='flex'>
            ...
            <div className='flex-col'>
              ...
              <div style={{ marginLeft: '50px' , minWidth: '600px', height: '400px' , overflowY: 'auto' }} className='customMargin  border-solid rounded-3xl  bg-[rgba(48,100,162,0.29)]  flex flex-col'>
                <StudentCardDisplay/>
                <StudentCardDisplay/>
                <StudentCardDisplay/>
                <StudentCardDisplay/>
