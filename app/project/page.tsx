      ...
      <div style={{minHeight: '780px', borderRadius:'24px' }} className='h-screen border-solid rounded-t-3xl box-border m-10 bg-[rgba(90,91,88,0.49)] pl-4 pt-7 '>
        ...
        <div style={{marginLeft: '0px' }} className='flex'>
            ...
            <div className='flex-col'>
              ...
              <div style={{ marginLeft: '50px' , width: '475px', minHeight: '300px', marginRight: '25px'}} className='customMargin box-border border-solid rounded-3xl  bg-[rgba(48,100,162,0.29)]  flex flex-col'>
                {modalOpen && (
                  <Modal 
                    closeModal ={() => {
                      setModalOpen(false);
